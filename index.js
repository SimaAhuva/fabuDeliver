...
const truckLocation = [-74.130051,40.74];
const warehouseLocation = [-74.130051, 40.739140, ];
const lastAtRestaurant = 0;
let keepTrack = [];
const pointHopper = {};

// Add your access token
mapboxgl.accessToken = 'pk.eyJ1IjoiYWxlaWNodGVyIiwiYSI6ImNsZWxqMDF0aDBsbm8zeG8xOTVvaTVlNTYifQ.zEw3jg4Zp6-FBPUT2pn5CA';
...
new mapboxgl.Marker(marker1).setLngLat(truckLocation).addTo(map);
